...
public class PBlockCropCotton extends PBlockFlower implements ITileEntityProvider
{
    ...
    public PBlockCropCotton(int par1, String textureBase, int stages)
    {
        super(par1);
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        droppedItem = new ItemStack(PItems.cottonSeed);
