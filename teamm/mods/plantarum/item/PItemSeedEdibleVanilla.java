...
public class PItemSeedEdibleVanilla extends ItemFood implements IPlantable
{
    //Tags
    ...
    public PItemSeedEdibleVanilla(int id, Block blockCrop, int growthSpeed, int output, int fertility, int luminous, int hardiness, int thorny, int hanging, int germinating, int restorative, int food, float sat)
    {
        super(id, food, sat, false); 
    ...
    {	        
        ...
        else if (par2EntityPlayer.canPlayerEdit(par4, par5, par6, par7, par1ItemStack) && par2EntityPlayer.canPlayerEdit(par4, par5 + 1, par6, par7, par1ItemStack))
        {
            ...
            if (soil != null && soil.canSustainPlant(par3World, par4, par5, par6, ForgeDirection.UP, this) && par3World.isAirBlock(par4, par5 + 1, par6))
            {
                ...
                TileEntityCropBase te = (TileEntityCropBase)par3World.getBlockTileEntity(par4, par5 + 1, par6);
