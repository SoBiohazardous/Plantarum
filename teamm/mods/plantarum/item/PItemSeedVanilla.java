...
public class PItemSeedVanilla extends Item implements IPlantable
{
    //Tags
    ...
    public PItemSeedVanilla(int id, Block blockCrop, int growthSpeed, int output, int fertility, int luminous, int hardiness, int thorny, int hanging, int germinating, int restorative)
    {
        super(id); 
